  ...
  <div class="error-page" v-if="page.isNotFound">
    <article class="page" itemtype="http://schema.org/BlogPosting">
      ...
      <section class="page__content page__markup" itemprop="articleBody">
        <div class="inner-wrap">
          <p>The requested page could not be found. Here is the image located at <a href="/playground" title="Check out the meme creator at the Playground">lbry://404</a> to console you.</p>
